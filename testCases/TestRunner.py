...
# import testCases
# from testCases.test_baidu_search import BaiduSearch
# from testCases.test_get_page_title import GetPageTitle
...
if __name__ == '__main__':
    ...
    runner = HTMLTestRunner(
        stream=fp, title="INSAIT KS Cloudweb Automated Test Report", description="测试结果：", verbosity=2
    )
